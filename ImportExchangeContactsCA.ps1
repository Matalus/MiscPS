...
Start-Transcript \\vault\tech3\Scripts\Matt\logs\ImportExchangeContactsCA.log

#Imports Exchange Management Shell Snap-in
Add-PSSnapin Microsoft.Exchange.Management.PowerShell.Admin

$CSV = Import-Csv "\\userdata\isshare$\helpdesk\Projects and Tasks\2014\Rob Ahrensdorf\CSV - Shamrock California Customer Email Addresses Sept 2013.csv"
...
Add-DistributionGroupMember -Identity "CA Street Sales" -Member $Contact.ExternalEmailAddress
}
Stop-Transcript