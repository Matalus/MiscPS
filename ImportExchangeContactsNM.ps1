...
Start-Transcript \\vault\tech3\Scripts\Matt\logs\ImportExchangeContactsNM.log

#Imports Exchange Management Shell Snap-in
Add-PSSnapin Microsoft.Exchange.Management.PowerShell.Admin

#Creates Variable object and imports CSV as an array
$CSV = Import-Csv "\\userdata\isshare$\helpdesk\Projects and Tasks\2014\Rob Ahrensdorf\CSV - Shamrock New Mexico Customers Email Addresses Sept 2013.csv"
...
Add-DistributionGroupMember -Identity "NM Street Sales" -Member $Contact.ExternalEmailAddress
}
Stop-Transcript