...
Start-Transcript \\vault\tech3\Scripts\Matt\logs\ImportExchangeContactsCO.log

#Imports Exchange Management Shell Snap-in
Add-PSSnapin Microsoft.Exchange.Management.PowerShell.Admin

$CSV = Import-Csv "\\userdata\isshare$\helpdesk\Projects and Tasks\2014\Rob Ahrensdorf\CSV - Shamrock Colorado Customer Email addresses Oct 2013.csv"
...
Add-DistributionGroupMember -Identity "CO Street Sales" -Member $Contact.ExternalEmailAddress
}
Stop-Transcript